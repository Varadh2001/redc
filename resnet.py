...
Original file is located at
    https://colab.research.google.com/drive/1bo4epZq4_wP1HbLekV7HUEjYvDnVK75e
"""
...
# Define the Residual Block with regular convolution and LeakyReLU activation function
...
class ResNet(nn.Module):
    def __init__(self, in_channels=1, out_channels=64, num_blocks=16):
        ...
        self.conv_out = nn.Conv2d(out_channels, in_channels, kernel_size=3, padding=1)
...
out_channels = 128  # number of channels in the ResNet blocks
num_blocks = 32  # number of ResNet blocks
